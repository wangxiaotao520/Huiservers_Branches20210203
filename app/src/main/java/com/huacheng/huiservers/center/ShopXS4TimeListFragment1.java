...
import com.huacheng.huiservers.shop.adapter.ShopXSList4_NoAdapter;
...
public class ShopXS4TimeListFragment1 extends BaseFragmentOld implements OnTabSelectListener {
    private RelativeLayout rel_no_data;
    ShopXSList4_NoAdapter mNoAdapter;
    ...
    public ShopXS4TimeListFragment1() {
        super();
    }
  ...
  //      SetTransStatus.GetStatus(getActivity());//系统栏默认为黑色
        ...
        mNoAdapter = new ShopXSList4_NoAdapter(getActivity(), mBeanALList);
...
//                     //   UIUtils.showToastSafe(msg);
    ...
    protected int getContentViewLayoutID() {
        return R.layout.shopxs4_timelist1;
    }
