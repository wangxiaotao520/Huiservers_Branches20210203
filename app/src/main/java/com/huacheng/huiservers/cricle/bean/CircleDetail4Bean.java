package com.huacheng.huiservers.cricle.bean;
 ...
 * 功能描述:Huiservers
 */
public class CircleDetail4Bean {
    ...
    private List<CircleDetail4Bean> img_list;

    private List<CircleDetail4Bean> reply_list;
    ...
    public List<CircleDetail4Bean> getImg_list() {
        return img_list;
    }

    public void setImg_list(List<CircleDetail4Bean> img_list) {
        this.img_list = img_list;
    }

    public List<CircleDetail4Bean> getReply_list() {
        return reply_list;
    }

    public void setReply_list(List<CircleDetail4Bean> reply_list) {
