...
public class PrivacyPolicyDialog extends AlertDialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String shequ = "欢迎您使用社区慧生活！我们将通过《社区慧生活服务协议》和《社区慧生活隐私政策》向您说明:为了让您使用我们的产品与/或服务，我们如何收集、使用、保存、共享和转让这些信息，以及我们为您提供的访问、更新、删除和保护这些信息的方式。\n" +
                "本协议与政策将帮助您了解以下内容:\n" +
                "1、我们如何收集和使用您的个人信息\n" +
                "2、我们如何使用Cookie和同类技术\n" +
                ...
                "7、通知和修订\n" +
                "8、如何联系我们\n" +
                "您可以通过阅读完整版《社区慧生活服务协议》和《社区慧生活隐私政策》，了解个人信息类型与用途的对应关系等更加详尽的个人信息处理规则。\n" +
...
//                mContext.startActivity(intent);
        ...
        String span = "完整版《社区慧生活服务协议》和《社区慧生活隐私政策》";
        spannableString.setSpan(clickableSpan, shequ.indexOf(span) + 3, shequ.indexOf(span) + 14, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
