...
public class PersoninfoBean implements Serializable{
	...
	public String getDecoration_num() {
		return decoration_num;
	}

	public void setDecoration_num(String decoration_num) {
		this.decoration_num = decoration_num;
	}
	...
	public void setHouse_address(PersoninfoBean house_address) {
	...
	public String getIs_user_archives() {
		return is_user_archives;
	}

	public void setIs_user_archives(String is_user_archives) {
		this.is_user_archives = is_user_archives;
	}
