...
import com.huacheng.huiservers.ui.index.wuye.bean.NewWuyeBean;
...
import com.huacheng.huiservers.ui.index.wuye.bean.WuyeInfoBean;
            ...
            if (StringUtils.isEquals(status, "1")) {
                ...
                for (int i = 0; i < objAry.length(); i++) {
                    ...
                    if (!StringUtils.isEmpty(infoStr)) {
                        ...
                        WuyeInfoBean info = new WuyeInfoBean();
                        ...
                        if (!StringUtils.isEmpty(dlistStr)) {
                            ...
                            WuyeInfoBean list = new WuyeInfoBean();
