package com.huacheng.huiservers.servicenew.ui.scan;
...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 边角线颜色
     */
    public int mLineColor = Color.parseColor("#ff5722");
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF, Color.parseColor("#ff5722"), 0x00FFFFFF};
