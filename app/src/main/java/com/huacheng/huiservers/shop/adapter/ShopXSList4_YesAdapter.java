...
public class ShopXSList4_YesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShopXSList4_YesAdapter(Context context, List<ShopIndexBean> mBeanList) {
