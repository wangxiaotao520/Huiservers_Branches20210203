...
public class ShopXSIngFragment extends BaseFragmentOld implements OnTabSelectListener {
    private RelativeLayout rel_no_data;
    ShopXSListYesAdapter mYesAdapter;
  ...
  //  List<ModelShopIndex> mBeanList = new ArrayList<>();
   ...
   //     SetTransStatus.GetStatus(getActivity());//系统栏默认为黑色
        ...
        mYesAdapter = new ShopXSListYesAdapter(mActivity, mBeanALList);
...
//        }
    ...
    protected int getContentViewLayoutID() {
        return R.layout.shopxs_time_list_ing;
    }
