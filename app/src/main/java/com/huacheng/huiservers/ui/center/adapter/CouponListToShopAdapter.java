...
public class CouponListToShopAdapter extends BaseAdapter {

    private Context mContext;
    List<CouponBean> mBeans;
    int mStatus;

    public CouponListToShopAdapter(List<CouponBean> beans, int status, Context context) {
        this.mBeans = beans;
        this.mStatus = status;
    ...
    public View getView(int p, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.coupon_toshop_item, null);
