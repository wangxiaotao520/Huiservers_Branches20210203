 ...
 * 功能描述:Huiservers
 */
public class NewHouseHandbookActivity extends BaseActivityOld {
  ...
  //      SetTransStatus.GetStatus(this);
        ...
        iv_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (login_type.equals("")|| ApiHttpClient.TOKEN==null||ApiHttpClient.TOKEN_SECRET==null) {
                    Intent intent = new Intent(NewHouseHandbookActivity.this, LoginVerifyCodeActivity.class);
    ...
    private void getNewHouse() {//获取我的新房详情
        ...
        HttpHelper hh = new HttpHelper(info.get_new_house, params, this) {
            ...
            protected void setData(String json) {
                ...
                mBookAdapter = new NewBookAdapter(NewHouseHandbookActivity.this, mList);
    ...
    public class NewBookAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(NewHouseHandbookActivity.this).load(MyCookieStore.URL + mHouseBeanList.get(position).getArticle_image()).skipMemoryCache(false).diskCacheStrategy(DiskCacheStrategy.NONE)
