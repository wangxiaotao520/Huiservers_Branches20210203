package com.huacheng.huiservers.ui.circle.bean;
...
public class CircleDetailBean {
    ...
    private List<CircleDetailBean> reply_list;
    ...
    public List<CircleDetailBean> getImg_list() {
        return img_list;
    }

    public void setImg_list(List<CircleDetailBean> img_list) {
        this.img_list = img_list;
    }

    public List<CircleDetailBean> getReply_list() {
        return reply_list;
    }

    public void setReply_list(List<CircleDetailBean> reply_list) {
