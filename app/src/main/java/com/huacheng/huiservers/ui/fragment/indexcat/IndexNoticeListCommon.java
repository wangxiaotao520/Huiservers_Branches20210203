...
public class IndexNoticeListCommon extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        for (int i = 0; i < 5; i++) {
            mDatas.add(new ModelNewWorkOrder());
        }
        indexNoticeAdapter = new IndexNoticeAdapter(mActivity, R.layout.item_index_notice, mDatas);
        mListView.setAdapter(indexNoticeAdapter);
    }
            ...
            public void onSuccess(int statusCode, JSONObject response) {
                ...
                if (JsonUtil.getInstance().isSuccess(response)) {
                    ...
                    if (info != null) {
                        ...
                        indexNoticeAdapter.notifyDataSetChanged();
                    }
                } else {
