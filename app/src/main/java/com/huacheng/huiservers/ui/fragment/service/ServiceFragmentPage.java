package com.huacheng.huiservers.ui.fragment.service;
...
public class ServiceFragmentPage extends BaseFragmentOld {
    ...
    private ServiceLifeOrderAdapter adapter;
    ...
    ListBean mTab;
    List<PropertyRepairBean> participates;
    private CenterProtocol protocol = new CenterProtocol();
    private List<PropertyRepairBean> participateAll = new ArrayList<PropertyRepairBean>();
                ...
                if (participates != null) {
                    if (participates.size() > 0) {
                        ...
                        if (page == 1) {
                            ...
                            adapter = new ServiceLifeOrderAdapter(participateAll, statusProtocol, getActivity());
