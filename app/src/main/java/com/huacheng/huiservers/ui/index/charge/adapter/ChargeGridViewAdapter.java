 ...
 * created by DFF
 */
public class ChargeGridViewAdapter extends CommonAdapter<ModelOldFile> {

    public ChargeGridViewAdapter(Context context, int layoutId, List<ModelOldFile> datas) {
    ...
    protected void convert(ViewHolder viewHolder, ModelOldFile item, int position) {
        ...
        if (position == 0) {
            ...
            viewHolder.<TextView>getView(R.id.tv_number).setTextColor(R.color.gray_66);
            ...
            viewHolder.<TextView>getView(R.id.tv_number).setTextColor(R.color.blackgray);
