...
public class ChargeGridViewTagAdapter extends CommonAdapter<ModelChargeDetail.PriceListBean> {
    ...
    public ChargeGridViewTagAdapter(Context context, int layoutId, List<ModelChargeDetail.PriceListBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder viewHolder, ModelChargeDetail.PriceListBean item, int position) {
