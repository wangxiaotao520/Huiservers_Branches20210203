 ...
 * 2020/10/4 0004 16:56
 */
public class OldInvestiagateActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void initData() {
        ...
        String url = ApiHttpClient.OLD_INVESTIGATION_QUESTION;
                ...
                if (JsonUtil.getInstance().isSuccess(response)) {
                    ...
                    if (information!=null){
                        if (information.getPlan()!=null){
                            GlideUtils.getInstance().glideLoad(OldInvestiagateActivity.this,ApiHttpClient.IMG_URL+information.getPlan().getImg(),iv_title_img,R.color.default_img_color);
                            ...
                            plan_id=information.getPlan().getIdX();
                        }
                ...
                if ("1".equals(model.getForm_type())) {
                    ...
                    gridviewImgsAdapter.setListener(new SelectImgAdapter.OnClickItemIconListener() {
                        ...
                        public void onClickImage(int position) {
                            ...
                            Intent intent = new Intent(OldInvestiagateActivity.this, PhotoViewPagerAcitivity.class);
...
//                    }).show();
    ...
    private void commitIndeed() {
        ...
        params.put("institution_id",modelOldIndexTop.getI_id()+"");
        params.put("institution_name",modelOldIndexTop.getI_name()+"");
        params.put("department_id",modelOldIndexTop.getD_id()+"");
        params.put("department_name",modelOldIndexTop.getD_name()+"");
        params.put("old_id",modelOldIndexTop.getOld_id());
        params.put("old_name",modelOldIndexTop.getName());
        params.put("old_phone",modelOldIndexTop.getOld_phone());
        ...
        MyOkHttp.get().post(ApiHttpClient.OLD_INVESTIGATION_QUESTION_COMMIT, params, new JsonResponseHandler() {
            @Override
            public void onSuccess(int statusCode, JSONObject response) {
                hideDialog(smallDialog);
                if (JsonUtil.getInstance().isSuccess(response)) {
...
//                    }
    ...
    private void commitWithImage(HashMap<String, String> params, Map<String, File> params_file) {
        ...
        MyOkHttp.get().upload(ApiHttpClient.OLD_INVESTIGATION_QUESTION_COMMIT, params, params_file, new JsonResponseHandler() {
            @Override
            public void onSuccess(int statusCode, JSONObject response) {
                hideDialog(smallDialog);
                if (JsonUtil.getInstance().isSuccess(response)) {
