        ...
        if (modelNewWorkOrder != null) {
            ...
            if (modelNewWorkOrder.getWork_user() != null && modelNewWorkOrder.getWork_user().size() > 0) {
                ...
                for (int i = 0; i < modelNewWorkOrder.getWork_user().size(); i++) {
                    ...
                    if (modelNewWorkOrder.getWork_user().get(i).getAttribute().equals("1")) {
                        tv_repair.setText("客服");
                    } else if (modelNewWorkOrder.getWork_user().get(i).getAttribute().equals("2")) {
                        tv_repair.setText("维修工");
                    } else if (modelNewWorkOrder.getWork_user().get(i).getAttribute().equals("3")) {
                        tv_repair.setText("经纪人");
