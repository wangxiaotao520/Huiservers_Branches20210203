...
public class WuyeInfoBean implements Serializable {
    ...
    public WuyeInfoBean getS_list() {
        return s_list;
    }

    public void setS_list(WuyeInfoBean s_list) {
        this.s_list = s_list;
    }

    public WuyeInfoBean getD_list() {
        return d_list;
    }

    public void setD_list(WuyeInfoBean d_list) {
        this.d_list = d_list;
    }
