package com.huacheng.huiservers.ui.servicenew;
 ...
 * created by DFF
 */
public class ServiceIndexActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        lin_s_scanCode = findViewById(R.id.lin_s_scanCode);
        lin_s_search = findViewById(R.id.lin_s_search);
        lin_s_order = findViewById(R.id.lin_s_order);
...
//        relMenuTop.setBackgroundAlpha(alpha);
            ...
            public void onSuccess(int statusCode, JSONObject response) {
                ...
                if (JsonUtil.getInstance().isSuccess(response)) {
                    ...
                    if (modelAds_list != null && modelAds_list.size() > 0) {
                        ...
                        rlv_service.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
    ...
    private void contentInflate(List<ModelAds> modelAds_list, ModelServiceIndex serviceInternal) {
        if (serviceInternal != null || (modelAds_list != null && modelAds_list.size() > 0)) {
            ...
            rlv_service.setLayoutManager(new LinearLayoutManager(this.getApplicationContext()));
            rlv_service.setItemAnimator(new DefaultItemAnimator());
            rlv_service.setAdapter(adapter_rlv);
                    ...
                    new RxPermissions(this).request(Manifest.permission.CAMERA)
                            .subscribe(new Consumer<Boolean>() {
                                ...
                                public void accept(Boolean isGranted) throws Exception {
                                    if (isGranted) {
                                        IntentIntegrator intentIntegrator = new IntentIntegrator(ServiceIndexActivity.this)
