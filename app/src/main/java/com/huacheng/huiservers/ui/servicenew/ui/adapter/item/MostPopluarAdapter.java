...
public class MostPopluarAdapter extends BaseAdapter {
    ...
    List<ModelCategoryService> mCateService;
    Context mContext;
    ViewHolder holder = null;

    public MostPopluarAdapter(List<ModelCategoryService> cateService, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ModelCategoryService cateService = mCateService.get(position);
