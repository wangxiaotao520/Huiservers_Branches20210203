...
public class ConfirmOrderActivityNew extends BaseActivityOld implements View.OnClickListener, ConfirmShopListAdapter.OnClickPeisongListener {
    ...
    protected void init() {
        ...
        adapter = new ConfirmShopListAdapter(ConfirmOrderActivityNew.this, mDatas, pro, this);
    ...
    private void getShopOrder() {//确认订单信息
        ...
        HttpHelper hh = new HttpHelper(info.submit_order_before, params, ConfirmOrderActivityNew.this) {
...
//                            txt_fenpei.setText("您的包裹将分成" + bean.getPro_num() + "个包裹配送给您");
                            ...
                            if ("1".equals(bean.getIs_coupon())) {
                                ...
                                txt_youhuiquan.setOnClickListener(ConfirmOrderActivityNew.this);
                            } else {
    ...
    private void getShopconfirm() {//立即支付
        ...
        params.addBodyParameter("products", gson.toJson(pro) + "");
        HttpHelper hh = new HttpHelper(info.submit_order, params, ConfirmOrderActivityNew.this) {
                ...
                if (!NullUtil.isStringEmpty(json)) {
                    try {
                        ...
                        if (JsonUtil.getInstance().isSuccess(response)) {
                            ...
                            Intent intent = new Intent(ConfirmOrderActivityNew.this, UnifyPayActivity.class);
                            Bundle bundle = new Bundle();
