 ...
 * 功能描述:Huiservers
 */
public class NewPingJiaActivity extends BaseActivityOld implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
 ...
 //       SetTransStatus.GetStatus(this);
    ...
    private void getsubmint() {//提交评价
        ...
        MyOkHttp.get().upload(info.shopping_order_score, params.getParams(), params_file, new RawResponseHandler() {
            @Override
