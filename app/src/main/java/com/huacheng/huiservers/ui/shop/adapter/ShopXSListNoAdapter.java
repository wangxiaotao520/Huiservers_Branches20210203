...
public class ShopXSListNoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShopXSListNoAdapter(Context context, List<ModelShopIndex> mBeanList) {
