...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(List<BannerBean> infoList, ImageCycleViewListener imageCycleViewListener) {
        if (infoList == null) {
            ...
            for (int i = 0; i < imageCount; i++) {
                ...
                if (i == 0) {
                    mImageViews[i].setBackgroundResource(R.drawable.page_focuese);
                } else {
                    mImageViews[i].setBackgroundResource(R.drawable.page_unfocused);
                }
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(R.drawable.page_focuese);
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 图片资源列表
         */
        private List<BannerBean> mAdList = new ArrayList<BannerBean>();
        ...
        public ImageCycleAdapter(Context context, List<BannerBean> adList, ImageCycleViewListener imageCycleViewListener) {
            mContext = context;
            mAdList = adList;
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mImageViewCacheList.isEmpty()) {
                ...
                //获取图片的宽高--start
                if(!NullUtil.isStringEmpty(mAdList.get(position).getImg_size()) ){
                    imageView.getLayoutParams().width = ToolUtils.getScreenWidth(mContext);
                    Double d = Double.valueOf(ToolUtils.getScreenWidth(mContext)) / (Double.valueOf(mAdList.get(position).getImg_size()));
