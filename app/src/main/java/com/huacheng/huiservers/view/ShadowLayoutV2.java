...
public class ShadowLayoutV2 extends RelativeLayout {
    ...
    public ShadowLayoutV2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShadowLayoutV2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ShadowLayoutV2);
        if (typedArray != null) {
            mShadowColor = typedArray.getColor(R.styleable.ShadowLayoutV2_shadowColor,
                    getContext().getResources().getColor(android.R.color.black));
            mShadowRadius = typedArray.getDimension(R.styleable.ShadowLayoutV2_shadowRadius, dip2px(0));
            mShadowDx = typedArray.getDimension(R.styleable.ShadowLayoutV2_shadowDx, dip2px(0));
            mShadowDy = typedArray.getDimension(R.styleable.ShadowLayoutV2_shadowDy, dip2px(0));
            mShadowSide = typedArray.getInt(R.styleable.ShadowLayoutV2_shadowSide, ALL);
            mShadowShape = typedArray.getInt(R.styleable.ShadowLayoutV2_shadowShape, SHAPE_RECTANGLE);
            typedArray.recycle();
        }
        setUpShadowPaint();
    }
