...
import com.huacheng.libraryservice.http.body.ProgressRequestBody;
import com.huacheng.libraryservice.http.body.ResponseProgressBody;
import com.huacheng.libraryservice.http.response.DownloadResponseHandler;
import com.huacheng.libraryservice.http.response.GsonResponseHandler;
...
import com.huacheng.libraryservice.http.response.RawResponseHandler;
...
public class MyOkHttp {
     ...
     */
    public void post(String url, final Map<String, String> params, final IResponseHandler responseHandler) {
    ...
    private class MyCallback implements Callback {
        ...
        public void onResponse(Call call, final Response response) throws IOException {
            if (response.isSuccessful()) {
                ...
                if (!NullUtil.isStringEmpty(response_body)) {
                    try {
                        JSONObject jsonObject = new JSONObject(response_body);
                        if (JsonUtil.getInstance().isTokenOverTime(jsonObject)) {
                            mHandler.post(new Runnable() {
                                @Override
                                public void run() {
