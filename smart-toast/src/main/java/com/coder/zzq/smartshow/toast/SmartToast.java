...
public final class SmartToast {
    ...
    public static boolean isShowing() {
        return ToastDelegate.get().isPlainShowing() || ToastDelegate.get().isTypeShowing() ||ToastDelegate.get().isMyTypeShowing();
    }
    ...
    public static void dismiss() {
        ...
        if (ToastDelegate.get().isMyTypeShowing()) {
            ToastDelegate.get().getMyTypeShowManager().dismiss();
        }
    }
     ...
     * @param msg
     */
    public static void showInfoLong(CharSequence msg) {

        ToastDelegate.get().getMyTypeShowManager().showInfoLong(msg);
    }
